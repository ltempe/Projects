...
namespace Traitement_Images
{
    ...
    public class QRCode
    {
        ...
        static SortedList<int, char> alphaNum; //Liste des caractères en code alphanumérique
        ...
        /// <param name="masque">Masque à appliquer, par défaut à -1 (dans ce cas, le meilleur masque sera déterminé automatiquement)</param>
        ...
        void CreerCarre(int posX, int posY, int tailleCarre, int couleur)
        {
        ...
        void RemplacerRectangle(int posX, int posY, int hauteur, int largeur)
        {
        ...
        int AppliquerMasque(int x, int y, int pix)
        {
            switch (masque)
            {
                case 0:
