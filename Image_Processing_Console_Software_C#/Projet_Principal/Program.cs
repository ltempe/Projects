...
namespace Traitement_Images
{
    ...
    public class Program
    {
        ...
        /// <summary>
        /// Permet d'enregistrer une image dans un dossier avec un nom préalablement défini
        /// </summary>
        /// <param name="nom">Nom prédéfini, varie en fonction de la méthode appliquée</param>
        /// <param name="nomDossier">Nom du dossier dans lequel on souhaite enregistrer l'image</param>
