...
namespace Traitement_Images
{
    ...
    public class MonImage
    {
        ...
        public void RemplirTableauOctets(byte[] sequence, int indice)
        {
        ...
        /// <returns></returns>
        public Pixel SommePixels(float[,] noyau, int ligne, int colonne)
        {
        ...
        public void ColorerFractale(byte intensite, int x, int y, int couleur, int n, int max)
        {
            Pixel pix = null;
            switch (couleur)
            {
        ...
        public int CalculerMax(int[] tableau)
        {
            int max = 0;
